<h1 align="center">👋 Olá, eu sou o Vinícius Blandy</h1>

<p align="center">
  <a href="https://www.linkedin.com/in/vin%C3%ADcius-blandy-94b159264/">
  ...
  <a href="mailto:vinicius.blandy@gmail.com">
    <img src="https://img.shields.io/badge/Contato-1A1A1A?style=for-the-badge&logo=gmail&logoColor=white" />
  </a>
</p>
...
Sou **desenvolvedor Front-end** com 3 anos de experiência, focado em criar interfaces modernas, performáticas e acessíveis.  
Atualmente faço parte da **CodeLab**, onde desenvolvo soluções completas — do layout ao consumo de APIs.  

🎯 Busco unir **design, performance e experiência do usuário** em cada projeto, sempre aplicando **boas práticas, componentização e clean code**.  
📚 Estudando continuamente **arquitetura de software, design patterns e integrações full stack**.  
...
- 🧱 **Clean Code, SOLID e Component-Based Architecture**  
- 🔁 **Padrões de versionamento (GitFlow)**  
- 🧠 **Design Patterns e modularização de componentes**  
- 📲 **Responsividade e Acessibilidade (WCAG)**  
- ⚡ **SEO e otimização de performance**  
- ⚙️ **Deploy contínuo e automação de builds (CI/CD)**  
- 🌐 **Tratamento de erros e gerenciamento de estados assíncronos**
...
<h4 align="center">📍 Salvador - Bahia, Brasil</h4>
